...
//   */
//  protected abstract void setNote(MusicEditorModel.Pitch newPitch, int newOctave, int newStart,
//                                  int newEnd,
//                                  int newInstrument, int newVolume);
  ...
  /**
   * Makes a new note with these characteristics
   */
  public static Note makeNote(int pitchNum, int start, int end, int
          instrument, int volume) {
    return new Note (end-start, (int)pitchNum / 12,start, Note.intToPitch
            (pitchNum), true, instrument, volume);
  }

  //todo clashes with our note class, what should i do?
